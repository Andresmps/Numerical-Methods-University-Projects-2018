...
package cuadradosmagicospasoapaso;
 ...
 */
//Hello World :v
public class CuadradosMagicosPasoAPaso {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        CuadradosMagicosPasoAPaso menu = new CuadradosMagicosPasoAPaso();
        menu.correrPrograma();
    ...
    public void correrPrograma() throws InterruptedException {
        ...
        for (k = 1; k <= (n * n); k++) {
            ...
            if (k == 1) {
                System.out.println("");
                System.out.println("");
                System.out.println("\ti = (a + (c * (k - 1)) + e * ((k - 1) / n))   %  n");
                System.out.println("\tj = (b + (d * (k - 1)) + f * ((k - 1) / n))   %  n");
                System.out.println("");
            }
            
            System.out.println("i = ("+a+" + ("+c+" * ("+(k-1)+") + ("+e+" * ("+(k-1)+") / "+n+"))) % "+n);
            System.out.println("i = ("+b+" + ("+d+" * ("+(k-1)+") + ("+f+" * ("+(k-1)+") / "+n+"))) % "+n);
            System.out.println("");
            System.out.println("En la fila: " + i+" y en la columna: "+ j+" el valor de k es igual a: "+k);
        ...
        System.out.println("");
        System.out.println("El cuadrado mágico resultante es: ");
        for (int l = 0; l < n; l++) {
            for (int m = 0; m < n; m++) {
                System.out.print("[ " + A[l][m] + " ]  ");
            }
